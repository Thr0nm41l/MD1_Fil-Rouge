...
|:---:|:---:|---|
| ✅ Présente | 5 | #3 Veille techno, #4 Cadre juridique+RSE, #7 Prototype, #9 Spécifications, #6 Faisabilité |
| ⚠️ Partielle | 4 | #1 Cartographie, #2 Cas d'usages, #5 Partage veille, #8 CDC |
| ❌ Absente | 0 | — |
