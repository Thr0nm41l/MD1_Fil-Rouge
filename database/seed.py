...
======================
Populates the database with realistic data for development and testing.
...
-----
    python seed.py
    python seed.py --host localhost --port 5432 --db Ecotrack --user postgres --password secret
    python seed.py --skip-history    # fast run without fill_history (useful for schema testing)
...
def main() -> None:
    ...
    try:
        ...
        log(f"  History    : {'skipped' if args.skip_history else f'{DAYS_HISTORY} days'}")
